...
/***/ function(module, exports) {
	...
	// cached from whatever global is present so that z_test runners that stub it
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function () {
	  ...
	  function runInContext(context, exports) {
	    ...
	    function has(name) {
	      if (has[name] !== undef) {
	        // Return cached feature z_test result.
	        return has[name];
	      }
	      var isSupported;
	      if (name == "bug-string-char-index") {
	        ...
	        if (name == "json-stringify") {
	          ...
	          if (stringifySupported) {
	            // A z_test function object with a custom `toJSON` method.
	            (value = function () {
	              return 1;
	            }).toJSON = value;
	            try {
	              stringifySupported =
	                ...
	                // Simple serialization z_test. FF 3.1b1 uses Unicode escape sequences
